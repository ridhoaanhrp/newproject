...
class BimbinganController extends Controller
{
    ...
    {
        $bimbing = DB::table('bimbingans')->join('mahasiswas', 'bimbingans.nim', '=', 'mahasiswas.nim')->join('dosens','bimbingan.kode_dosen','=', 'dosens.kode_dosen1')->join('progress', 'bimbingan.id_progress', '=', 'progress.id')->get();
